...
public class VentanaCombateBeta extends Ventana implements ActionListener {
    ...
    private JLabel puntosDeVidaAnimalUsuario;
    private JLabel puntosDeVidaAnimalElegido;
    ...
    public VentanaCombateBeta(Jugador jugador, Animal animalJugador, Animal animalZona){
        ...
        this.generarEtiquetaBlanca("Puntos de vida: ",500,270,190,20,"arial",15);
        this.generarEtiquetaBlanca("Puntos de vida: ",500,250,190,20,"arial",15);
